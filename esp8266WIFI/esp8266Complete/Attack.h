...
extern uint32_t currentTime; //Used to sync attacks, was imported in .ino in setup() with     // get time  currentTime = millis();

extern void getRandomMac(uint8_t* mac); //extern because the function was imported/included from .ino
